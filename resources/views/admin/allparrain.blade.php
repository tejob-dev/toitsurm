    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
                        <h2>Liste des parrainages enrégistrés</h2>
                    </div>
                    <div class="col-sm-6">
                        <div class="d-flex justify-content-end" style="width:450px; margin-left: auto;">
                            ...
                            <a href="/manage-parrain/export/all" class="btn btn-white bg-white text-dark" style="width:230px;"><span>Exporter en Excel</span></a>
                            <!--Okay-->
                        </div>
                        <div class="d-flex justify-content-end my-2" style="width: 450px; margin-left: auto;">
                            <form action="/parrains/filter" method="post" class="w-50">
                                @csrf
            ...
            <table class="table table-striped table-hover">
                <thead>
                    <tr>
                        ...
                        <!--    </span>-->
                        <!--</th>-->
                        <th>Nom/Prénom du parrain</th>
                        <th>Son email</th>
                        <th>Nom/Prénom du parrainé</th>
                        <th>Email du parrainé</th>
                        <th>Telephone du parrainé</th>
                        <th>Options</th>
                    </tr>
                </thead>
                <tbody>
                    @foreach ($allparrains as $id => $data)
                        <tr>
                            <!--<td>-->
                            <!--    <span class="custom-checkbox">-->
                            ...
                            <td>{{$data->email}}</td>
                            <td>{{$data->parnom." ".$data->parprenom}}</td>
                            <td>{{$data->paremail}}</td>
                            <td>{{$data->partelephone}}</td>
                            {{-- <td>{{date('d/m/Y', strtotime($data->created_at))}}</td> --}}
                            <td>
                                <!--<a href="{{"/manage-parrain/".$id}}" class="view"><i class="material-icons" data-toggle="tooltip" title="Voir les détails">&#xE417;</i></a>-->
                                <a href="{{'/manage-parrain/'.$data->id.'/edit'}}" class="edit"><i class="material-icons" data-toggle="tooltip" title="Edit les détails">&#xE3C9;</i></a>
            ...
            <div class="flex items-center mt-2">
                ...
                <p style="font-size: 18px;">
                    Affichage {{$allparrains->count()}} sur {{ $allparrains->total() }} parrainage(s).
                </p>
            </div>
        </div>
    </div>
    <div id="deleteEmployeeModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <form method="post" action="/manage-parrain/delete" >
                    @csrf

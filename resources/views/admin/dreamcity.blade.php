...
@section('content')
<div class="container">
    <nav class="bg-gray-50 dark:bg-gray-700 my-3">
        <div class="max-w-screen-xl px-4 py-3 mx-auto md:px-6">
            <div class="flex items-center justify-end">
                <ul class="flex flex-row mt-0 mr-6 space-x-8 text-sm font-medium">
                    <li>
                        <a href="/manage-dream/create" class="text-gray-900 dark:text-white hover:underline">Créer une place sur DreamCity</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="table-wrapper">
                ...
                <tbody>
                    @foreach ($dreams as $key => $data)
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="/manage-dream/{{$data->id}}/edit" class="edit" ><i class="material-icons" data-toggle="tooltip" title="Editer l'element DreamCity">&#xE254;</i></a>
            ...
            <div class="flex items-center mt-2">
                ...
                <p style="font-size: 18px;">
                    Affichage {{$dreams->count()}} sur {{ $dreams->total() }} element(s).
                </p>
            </div>
        </div>
    </div>
    <div id="deleteEmployeeModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <form method="post" action="/manage-quiz/delete" >
                    @csrf
